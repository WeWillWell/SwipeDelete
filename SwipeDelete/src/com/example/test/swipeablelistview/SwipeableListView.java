...
package com.example.test.swipeablelistview;
...
import com.example.test.swipeablelistview.SwipeHelper.Callback;
public class SwipeableListView extends ListView implements Callback {
    private SwipeHelper mSwipeHelper;
    private boolean mEnableSwipe = false;

    public static final String LOG_TAG = "SwipeableListView";
